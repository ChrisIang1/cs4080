...
#define AS_SHORT_STRING_LENGTH(value) ((value).as.shortString.length)
#define AS_SHORT_STRING_CHARS(value) ((value).as.shortString.chars)
//< Types of Values as-macros
...
static inline Value shortStringVal(const char* chars, int length) {
  ...
  memset(value.as.shortString.chars, 0, SHORT_STRING_MAX);
